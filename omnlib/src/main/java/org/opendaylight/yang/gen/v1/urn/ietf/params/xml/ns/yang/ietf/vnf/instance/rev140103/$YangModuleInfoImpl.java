...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "ietf-vnf-instance";
    private final String namespace = "urn:ietf:params:xml:ns:yang:ietf-vnf-instance";
    private final String revision = "2014-01-03";
    private final String resourcePath = "/META-INF/yang/ietf-vnf-instance.yang";
