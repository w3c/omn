 ...
 *       &lt;attribute name="vlantag" type="{http://www.w3.org/2001/XMLSchema}string" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "")
@XmlRootElement(name = "link_shared_vlan", namespace = "http://www.geni.net/resources/rspec/ext/shared-vlan/1")
public class LinkSharedVlan {

    @XmlAttribute(name = "name", required = true)
    protected String name;
    @XmlAttribute(name = "vlantag")
